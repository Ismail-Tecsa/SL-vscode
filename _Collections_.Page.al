page 50050 "Collections"
{
        ...
        field("Payment Method Code";"Payment Method Code")
        {
          ...
          trigger OnValidate()begin
            ...
            if PaymentMethod.get("Payment Method Code")then begin
              IF PaymentMethod."Bal. Account Type" = PaymentMethod."Bal. Account Type"::"Bank Account" THEN VALIDATE("Bal. Account Type", "Bal. Account Type"::"Bank Account")
              ELSE
  ...
  trigger OnClosePage()var SH: Record "Sales Header";
