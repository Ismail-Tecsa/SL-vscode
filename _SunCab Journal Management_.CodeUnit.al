codeunit 50001 "SunCab Journal Management"
{
  ...
  Balancing: Boolean)var Bank: record "Bank Account";
  ...
  begin
    ...
    repeat if genjnlLine."Bal. Account Type" = genjnlline."Bal. Account Type"::"Bank Account" then begin
  ...
  _days: Integer)Amount: Decimal var ContHead: record "Service Contract Header";
