page 50026 "Owner Details FactBox"
{
  ...
  var LicStatus1: Option Active, Expired;
  ...
  local procedure ShowDetailsOwner()begin
    PAGE.Run(PAGE::"Driver Card", Owner);
  end;
  local procedure ShowDetailsDriver1()begin
    PAGE.Run(PAGE::"Driver Card", Driver1);
  end;
  local procedure ShowDetailsDriver2()begin
