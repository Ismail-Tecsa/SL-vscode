tableextension 50004 "Gen. Journal Line Extension" extends "Gen. Journal Line"
{
  fields
  {
    field(50000;"Contract No.";Code[20])
    {
      ...
      trigger OnValidate()var SCH: record "Service Contract Header";
      ...
      begin
        if sch.get("Contract No.")then begin
          ...
          if scl.findfirst then "Taxi No.":=scl."Service Item No.";
        end;
      end;
    }
  ...
  var SunLightMgmt: Codeunit "SunCab Journal Management";
}
