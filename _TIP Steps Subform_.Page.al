      ...
      group("&Line")
      {
        ...
        group("F&unctions")
        {
          ...
          action("Create Steps")
          {
            ...
            trigger OnAction()var tipmaster: Record "TIP Master Setup";
        ...
        action("Start Next Step")
        {
          ...
          begin
            ...
            tipentry.setrange("Taxi ID", "Taxi ID");
            tipentry.findfirst();
            repeat if tipentry.Status = tipentry.Status::Open then begin
        ...
        action("Complete Current Step")
        {
          ...
          trigger OnAction()var tipentry: Record "TIP Entry";
          begin
            tipentry.Reset();
            tipentry.setrange("Taxi ID", "Taxi ID");
            tipentry.findfirst();
            repeat if tipentry.Status = tipentry.Status::"In Progress" then begin
